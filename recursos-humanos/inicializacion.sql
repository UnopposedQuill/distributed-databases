...
insert into Profesor(nombre, apellidos, plaza, activo) values
	...
	('Profesor', 'Prueba 2', 'Cartago', 0),
	('Profesor', 'Otra Sede', 'Otra sede', 1),
	('Profesor', 'Otra Sede 2', 'Otra sede', 1),
	('Profesor', 'Otra Sede 3', 'Otra sede', 1);


select P.id, P.nombre, P.apellidos, P.activo, ROW_NUMBER() over(Partition by P.plaza order by P.id asc) as 'Row Number' from Profesor P